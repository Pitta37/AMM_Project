package ClassiServlet;
import ClassiNerdbook.*;
...
public class Login extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
        ...
        else //Se l'utente non è loggato... 
        {
            ...
            {
                int loggedUserID = UserFactory.getInstance().getIdUserAndPassword(username, password);
                //se l'utente è presente
                if(loggedUserID!=-1)
                {
                    session.setAttribute("loggedIn", true);
                    session.setAttribute("loggedUserID", loggedUserID);
                    User u=UserFactory.getInstance().getUserId(loggedUserID);
                    if(u.getNome()==null || u.getCognome()==null || u.getFrase()==null)
